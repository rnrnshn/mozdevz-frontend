...
export function LogoContainer() {
  return (
    <Container>
      <LogoCard>
        <Image src={cca} alt="Centro Cultural Americano" />
      </LogoCard>
      <LogoCard>
        <Image src={ciuem} alt="Centro Cultural Americano" />
      </LogoCard>
      <LogoCard>
        <Image src={reino} alt="Centro Cultural Americano" />
      </LogoCard>
      <LogoCard>
        <Image src={psi} alt="Centro Cultural Americano" />
      </LogoCard>
      <LogoCard>
        <Image src={coworklab} alt="Centro Cultural Americano" />
      </LogoCard>
      <LogoCard>
        <Image src={mctestp} alt="Centro Cultural Americano" />
      </LogoCard>
      <LogoCard>
        <Image src={oxfam} alt="Centro Cultural Americano" />
      </LogoCard>
    </Container>
  )
}
